...
\details{
The SorensenÃÂs dissimilarity index allows computing  the PhyloSor index (Bryant et al. 2008) whereas the JaccardÃÂs dissimilarity index allows computing the UniFrac index (Lozupone & Knight 2005).
}
...
Faith DP, Lozupone CA, Nipperess D, Knight R (2009) The Cladistic Basis for the Phylogenetic Diversity (PD) Measure Links Evolutionary Features to Environmental Gradients and Supports Broad Applications of Microbial Ecology's "Phylogenetic Beta Diversity" Framework. Int J Mol Sci 10: 4723ÃÂ4741. doi: 10.3390/ijms10114723.
...
\author{
Julien De Bortoli (juldebortoli@yahoo.fr), Fabien Leprieur(fabien.leprieur@univ-montp2.fr), Andres Baselga and David Orme
}
