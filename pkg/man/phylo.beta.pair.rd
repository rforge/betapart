...
\details{
The Sorensen's dissimilarity index allows computing  the PhyloSor index (Bryant et al. 2008) whereas the JaccardÃÂs dissimilarity index allows computing the UniFrac index (Lozupone & Knight 2005).
}
